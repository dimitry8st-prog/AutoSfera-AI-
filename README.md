...
- типовые разговорные фразы обрабатываются AI Orchestrator на основании публичного раздела RAG без ложной эскалации;
- 4 агента и 17 skills: продажи, поддержка, сервис, внутренний помощник и исследование конкурентов;
- встроенный роутер выбирает готовый Skill, простую или сложную модель, уточнение либо передачу сотруднику;
