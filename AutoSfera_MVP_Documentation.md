...
Рабочий чат мультиагентной системы AutoSfera: оркестратор маршрутизирует обращение, агент отвечает через Skills и RAG по JSON Knowledge Base.
...
*AutoSfera MVP v1.1 — учебный проект. Данные вымышлены.*
